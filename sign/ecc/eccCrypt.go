...
func (e *EccSign) EccEncryptToBase64(plainText []byte, base64PubKey string) (base64CipherText string, err error) {
...
func (e *EccSign) EccDecryptByBase64(base64CipherText, base64PriKey string) (plainText []byte, err error) {
...
func (e *EccSign) EccEncryptToHex(plainText []byte, hexPubKey string) (hexCipherText string, err error) {
...
func (e *EccSign) EccDecryptByHex(hexCipherText, hexPriKey string) (plainText []byte, err error) {
